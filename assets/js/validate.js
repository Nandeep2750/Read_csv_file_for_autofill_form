 ...
 (function(a) {
    a.extend(a.fn, {
        ...
        messages: {
            ...
            alpha_numeric: "Password should contain at least 1 Alphabet, 1 Number and 1 Special Character"
        },
        autoCreateRanges: !1,
        prototype: {
            init: function() {
            ...
            showErrors: function(b) {
                ...
                defaultShowErrors: function() {
                    ...
                    methods: {
                        ...
                        alpha_numeric: function(a, b) {
                            return this.optional(b) || /^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#\$%\^&\*])(?=.{6,})/.test(a)
                        },
                        digits: function(a, b) {
